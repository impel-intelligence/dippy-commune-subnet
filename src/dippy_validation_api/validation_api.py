...
from dippy_validation_api.scores import StatusEnum
from dippy_validation_api.validation_utils import (
    regenerate_hash,
)
from dippy_validation_api.repo_details import (
    get_model_size,
check_model_repo_details,
ModelRepo,

)
from dippy_validation_api.event_logger import EventLogger
from dippy_validation_api.common import EvaluateModelRequest
from dotenv import load_dotenv
...
def start():
    ...
    parser.add_argument("--main-api-port", type=int, default=9111, help="Port for the main API")
